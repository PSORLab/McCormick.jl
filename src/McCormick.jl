...
export MC, cc, cv, Intv, lo, hi,  cc_grad, cv_grad, cnst, +, -, *, /, convert,
       ...
       sind, cosd, tand, asind, acosd, atand, nan, erf, erfinv, erfc, erfcinv,
...
export plus_kernel, minus_kernel, mult_kernel, div_kernel, max_kernel,
       ...
       erfinv_kernel, erfc_kernel, erfcinv_kernel, relu_kernel,
       ...
       abs2_kernel, sinpi_kernel, cospi_kernel, arh_kernel

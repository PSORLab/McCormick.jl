...
@inline function sqr_kernel(x::MC{N,T}, y::Interval{Float64}) where {N,T<:Union{NS,MV}}
	if (x.Intv.bareinterval.hi < 0.0)
       eps_min = x.Intv.bareinterval.hi
       eps_max = x.Intv.bareinterval.lo
    elseif (x.Intv.bareinterval.lo > 0.0)
       eps_min = x.Intv.bareinterval.lo
       eps_max = x.Intv.bareinterval.hi
    else
       eps_min = 0.0
       eps_max = (abs(x.Intv.bareinterval.lo) >= abs(x.Intv.bareinterval.hi)) ? x.Intv.bareinterval.lo : x.Intv.bareinterval.hi
    end
	midcc, cc_id = mid3(x.cc, x.cv, eps_max)
	midcv, cv_id = mid3(x.cc, x.cv, eps_min)
	cc = cc_sqr(midcc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi)
	dcc = dcc_sqr(midcc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi)
	cv = cv_sqr_NS(midcv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi)
	dcv = dcv_sqr_NS(midcv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi)
...
@inline function sqr_kernel(x::MC{N,Diff}, y::Interval{Float64}) where N
	...
	midcc, cc_id = mid3(x.cc, x.cv, eps_max)
	cc = cc_sqr(midcc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi)
    cv = cv_sqr(midcv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi)
    gdcv1 = dcv_sqr(x.cv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi)
    gdcv2 = dcv_sqr(x.cc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi)
    gdcc1 = dcc_sqr(x.cv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi)
    gdcc2 = dcc_sqr(x.cc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi)
...
@inline sqr(x::MC) = sqr_kernel(x, pown(x.Intv,2))
...
@inline function npp_or_pow4(x::MC{N,T}, c::Z, y::Interval{Float64}) where {N, Z<:Integer, T<:Union{NS,MV}}
    ...
    elseif (x.Intv.bareinterval.lo > 0.0)
  	...
  	midcc, cc_id = mid3(x.cc, x.cv, eps_max)
  	midcv, cv_id = mid3(x.cc, x.cv, eps_min)
  	cc, dcc = cc_npp_or_pow4(midcc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
  	cv, dcv = cv_npp_or_pow4(midcv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
  	cc_grad = mid_grad(x.cc_grad, x.cv_grad, cc_id)*dcc
  	cv_grad = mid_grad(x.cc_grad, x.cv_grad, cv_id)*dcv
  	cv, cc, cv_grad, cc_grad = cut(y.bareinterval.lo, y.bareinterval.hi, cv, cc, cv_grad, cc_grad)
  	return MC{N,T}(cv, cc, y, cv_grad, cc_grad, x.cnst)
...
@inline function npp_or_pow4(x::MC{N,Diff}, c::Z, y::Interval{Float64}) where {N, Z<:Integer}
  	...
  	cc, dcc = cc_npp_or_pow4(midcc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
  	cv, dcv = cv_npp_or_pow4(midcv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
  	gcc1, gdcc1 = cc_npp_or_pow4(x.cv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
  	gcv1, gdcv1 = cv_npp_or_pow4(x.cv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
  	gcc2, gdcc2 = cc_npp_or_pow4(x.cc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
  	gcv2, gdcv2 = cv_npp_or_pow4(x.cc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
  	cv_grad = max(0.0, gdcv1)*x.cv_grad + min(0.0, gdcv2)*x.cc_grad
  	cc_grad = min(0.0, gdcc1)*x.cv_grad + max(0.0, gdcc2)*x.cc_grad
  	return MC{N,Diff}(cv, cc, y, cv_grad, cc_grad, x.cnst)
end
...
@inline function pos_odd(x::MC{N,T}, c::Z, y::Interval{Float64}) where {N, Z<:Integer, T<:Union{NS,MV}}
    ...
    cc, dcc = cc_powodd_ns(midcc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    cv, dcv = cv_powodd_ns(midcv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    cc_grad = mid_grad(x.cc_grad, x.cv_grad, cc_id)*dcc
    cv_grad = mid_grad(x.cc_grad, x.cv_grad, cv_id)*dcv
	cv, cc, cv_grad, cc_grad = cut(y.bareinterval.lo, y.bareinterval.hi, cv, cc, cv_grad, cc_grad)
    return MC{N,T}(cv, cc, y, cv_grad, cc_grad, x.cnst)
...
@inline function pos_odd(x::MC{N,Diff}, c::Z, y::Interval{Float64}) where {N, Z<:Integer}
    midcc, cc_id = mid3(x.cv, x.cc, x.Intv.bareinterval.hi)
    midcv, cv_id = mid3(x.cv, x.cc, x.Intv.bareinterval.lo)
    cc, dcc = cc_powodd(midcc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    cv, dcv = cv_powodd(midcv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    gcc1, gdcc1 = cc_powodd(x.cv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    gcv1, gdcv1 = cv_powodd(x.cv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    gcc2, gdcc2 = cc_powodd(x.cc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    gcv2, gdcv2 = cv_powodd(x.cc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    cv_grad = max(0.0, gdcv1)*x.cv_grad + min(0.0, gdcv2)*x.cc_grad
    cc_grad = min(0.0, gdcc1)*x.cv_grad + max(0.0, gdcc2)*x.cc_grad
    return MC{N,Diff}(cv, cc, y, cv_grad, cc_grad, x.cnst)
end
...
@inline function flt_pow_1(x::MC{N,T}, c::Float64, y::Interval{Float64}) where {N, T<:Union{NS,MV}}
	midcc, cc_id = mid3(x.cc, x.cv, x.Intv.bareinterval.hi)
	midcv, cv_id = mid3(x.cc, x.cv, x.Intv.bareinterval.lo)
	cc, dcc = cc_flt_pow_1(midcc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
	cv, dcv = cv_flt_pow_1(midcv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    cc_grad = mid_grad(x.cc_grad, x.cv_grad, cc_id)*dcc
    cv_grad = mid_grad(x.cc_grad, x.cv_grad, cv_id)*dcv
    cv, cc, cv_grad, cc_grad = cut(y.bareinterval.lo, y.bareinterval.hi, cv, cc, cv_grad, cc_grad)
    return MC{N,T}(cv, cc, y, cv_grad, cc_grad, x.cnst)
...
@inline function flt_pow_1(x::MC{N,Diff}, c::Float64, y::Interval{Float64}) where N
	...
	cc, dcc = cc_flt_pow_1(midcc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
	cv, dcv = cv_flt_pow_1(midcv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    gcc1, gdcc1 = cc_flt_pow_1(x.cv ,x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    gcv1, gdcv1 = cv_flt_pow_1(x.cv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    gcc2, gdcc2 = cc_flt_pow_1(x.cc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    gcv2, gdcv2 = cv_flt_pow_1(x.cc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi, c)
    cv_grad = max(0.0, gdcv1)*x.cv_grad + min(0.0, gdcv2)*x.cc_grad
    cc_grad = min(0.0, gdcc1)*x.cv_grad + max(0.0, gdcc2)*x.cc_grad
    return MC{N,Diff}(cv, cc, y, cv_grad, cc_grad, x.cnst)
end
...
@inline function inv1(x::MC{N,T}, y::Interval{Float64}) where {N,T<:Union{NS,MV}}
	...
	eps_max = x.Intv.bareinterval.lo
  	midcc, cc_id = mid3(x.cc, x.cv, eps_max)
  	midcv, cv_id = mid3(x.cc, x.cv, eps_min)
  	cc, dcc = cc_inv1(midcc, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi)
  	cv, dcv = cv_inv1(midcv, x.Intv.bareinterval.lo, x.Intv.bareinterval.hi)
  	cc_grad = mid_grad(x.cc_grad, x.cv_grad, cc_id)*dcc
  	cv_grad = mid_grad(x.cc_grad, x.cv_grad, cv_id)*dcv
  	cv, cc, cv_grad, cc_grad = cut(y.bareinterval.lo, y.bareinterval.hi, cv, cc, cv_grad, cc_grad)
  	return MC{N,T}(cv, cc, y, cv_grad, cc_grad, x.cnst)
...
@inline function inv_kernel(x::MC{N,T}, y::Interval{Float64}) where {N,T<:RelaxTag}
	...
	if x.Intv.bareinterval.hi < 0.0
		x = -inv1(-x, -y)
  	else x.Intv.bareinterval.lo > 0.0
		x = inv1(x, y)
	end
	return x
end
